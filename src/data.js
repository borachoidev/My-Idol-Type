...
export const infoList = [
  {
    ...
    desc: '자신만의 세계에 있는 당신은 신비주의?! 무슨 생각을 하고있는지 모르겠는 오묘한 매력이 팬들의 관심을 불어일으킨답니다🔮',
    partner: '선후배 상관없이 두루두루 잘지내는 인싸돌',
    img: img1,
  },
  {
    name: '선후배 상관없이 두루두루 잘지내는 인싸돌',
    desc: '만나는 사람마다 팬으로 만들어버리는 당신은 이 시대의 인싸! 훌륭한 말솜씨와 모든 사람에게 친근한 당신은 누구와도 친해질 수 있고 모든 사람을 당신의 팬으로 만들어요! ',
